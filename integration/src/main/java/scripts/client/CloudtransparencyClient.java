...
import bio.terra.cloudtransparency.client.ApiClient;
...
public class CloudtransparencyClient extends ApiClient {
   ...
   */
  public CloudtransparencyClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public CloudtransparencyClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
